async function checkSimulationStatus() {
    const response = await fetch('/simulationStatus'); // await means the script will pause until /siumulation_status responds since it is an asynchronous function
    ...
    if (result.status === 'complete') {
        ...
        window.location.href = '/comparison-page';
    } else {
